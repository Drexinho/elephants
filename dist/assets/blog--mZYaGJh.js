import{l as c,a as i,g as d}from"./posts-DTqejJVh.js";function s(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const l=document.getElementById("blog-list"),o=document.getElementById("blog-single"),m=document.getElementById("blog-single-content");function g(){const e=d().sort((t,a)=>new Date(a.date)-new Date(t.date));l.innerHTML=e.map(t=>{const a=t.image?`<img src="${s(t.image)}" alt="" class="w-full aspect-video object-cover rounded-xl" loading="lazy" />`:"";return`
